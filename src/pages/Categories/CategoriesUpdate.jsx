...
const CategoriesUpdate = () => {
  ...
  const handleCategorySubmit = (categoryData) => {
    ...
    setSubmitting(true);
    axios
      .patch(`${import.meta.env.VITE_API_URL}/categories/${id}`, {
        ...categoryData,
    ...
    axios
      ...
      .catch((error) => {
        if (error.response.data.code && error.response.data.code === "P2003") {
          message.error(
            "Erro! Categorias com items associados não podem ser removidas"
          );
        } else {
          ...
          <Space direction={"vertical"}>
            ...
            >
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Digite o nome da categoria" },
                ]}
                required
              >
