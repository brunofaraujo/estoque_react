          ...
          <Layout style={{ backgroundColor: "#fff" }}>
            <Row gutter={[25, 20]}>
              ...
              <Col xs={24} sm={12} md={12} lg={8} xl={8}>
                <Card bordered={true}>
                  <Statistic
                    ...
                    prefix={
                      <TfiDirection size={35} style={{ marginRight: 20 }} />
                    }
                    groupSeparator={"."}
                    decimalSeparator={","}
                  />
              ...
              <Col xs={24} sm={12} md={12} lg={8} xl={8}>
                <Card bordered={true}>
                  <Statistic
                    ...
                    prefix={
                      <TfiViewGrid size={35} style={{ marginRight: 20 }} />
                    }
                    groupSeparator={"."}
                    decimalSeparator={","}
                  />
              ...
              <Col xs={24} sm={12} md={12} lg={8} xl={8}>
                <Card bordered={true}>
                  <Statistic
                    ...
                    prefix={
                      <TfiDropbox size={35} style={{ marginRight: 20 }} />
                    }
                    groupSeparator={"."}
                    decimalSeparator={","}
                  />
              ...
              <Col xs={24} sm={12} md={12} lg={8} xl={8}>
                <Card bordered={true}>
                  <Statistic
                    title={<h3>Usuários</h3>}
                    value={summary.users}
                    prefix={
                      <SlUserFollowing size={35} style={{ marginRight: 20 }} />
                    }
                    groupSeparator={"."}
                    decimalSeparator={","}
                  />
